...
def main():
    parser = argparse.ArgumentParser(description="MLX Https Server.")
    parser.add_argument(
        "--model",
        type=str,
        required=True,
    ...
    parser.add_argument(
        ...
        type=str,
        default="127.0.0.1",
        help="Host for the HTTPS server (default: 127.0.0.1)",
    )
    parser.add_argument(
        "--certificate",
        type=str,
        help="Certificate PEM file for the HTTPS server",
    )
    parser.add_argument(
        "--key",
        type=str,
        help="Key PEM file for the HTTPS server",
    )
    parser.add_argument(
        "--port",
        type=int,
    ...
    run(args.host, args.port, args.certificate, args.key, model, tokenizer)
